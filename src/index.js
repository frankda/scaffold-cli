...
const component = fs.readFileSync('./src/template/component.max', 'utf8');
const componentTemplate = fs.readFileSync('./src/template/component-template.max', 'utf8');
const componentScss = fs.readFileSync('./src/template/_component.max', 'utf8');
